-- View: Funnel Monthly Trend
-- Monthly conversion trends over the 6-month period
CREATE VIEW funnel_monthly_trend AS
WITH session_page_flags AS (
    ...
    GROUP BY ws.website_session_id, strftime('%Y-%m', ws.created_at)
)
SELECT 
    month,
